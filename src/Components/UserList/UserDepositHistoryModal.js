...
function UserDepositHistoryModal({ open, handleOpen, item }) {
  ...
  return (
    <>
      ...
      >
        <DialogHeader className="items-start flex flex-wrap justify-between mb-6 p-0 pr-9">
...
export default UserDepositHistoryModal;
