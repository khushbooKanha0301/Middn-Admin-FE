...
function Deposit() {
  ...
  const tablebody = [
    ...
    },
    {
      ...
      Status: (
        <button className="table-btn initiated initiatedbtn">Initiated</button>
      ),
      Action: Desktop,
    },
    {
    ...
    },
    {
      ...
      Status: (
        <button className="table-btn Completed succeedbtn">Succeed</button>
      ),
      Action: Desktop,
    },
    {
  ...
  const handleOpen = (item) => { 
    if(item.User)
    {
      if(item.Status.props.children == "Approved"){
        setValue(true);
      }else if(item.Status.props.children == "Initiated"){
        setItem({status:"Initiated"})
        setStatusModal(true)
      }else if(item.Status.props.children == "Rejected"){
        setItem({status:"Rejected"})
        setStatusModal(true)
      }else if(item.Status.props.children == "Succeed"){
        setItem({status:"Succeed"})
        setStatusModal(true)
      }else{
        setOpen(true); 
      }
  ...
  const handleOpened = () => setValue(!value);
    ...
    <>
            ...
            <div className="tabsrow flex flex-wrap justify-between mb-[15px] gap-3">
              ...
              >
                ...
                <li>
                  <Link
                    className={
                      selectedStatusFilter === "succeedbtn" ? "active" : ""
                    }
                    onClick={() => setSelectedStatusFilter("succeedbtn")}
                  >
                    Successful
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    className={
                      selectedStatusFilter === "initiatedbtn" ? "active" : ""
                    }
                    onClick={() => setSelectedStatusFilter("initiatedbtn")}
                  >
                    Initiated
                  </Link>
                </li>
                  ...
                  {filteredTableBody.map((item, index) => (
                    <tr key={index}>
                      <>
                        ...
                        <td>{item.Status}</td>
                        <td>
                          <Link className="action" onClick={() => handleOpen(item)} variant="gradient">
      ...
      >
        <DialogHeader className="items-start flex flex-wrap justify-between mb-6 p-0 pr-9 gap-3">
          <h3 className="text-white pt-2">Deposit via Mobile Money</h3>
        ...
        <DialogBody divider className="border-none p-0">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="sm:-translate-y-12">
              <h3 className="text-white mb-6">Deposit Information</h3>
        ...
        <DialogFooter className="absolute top-[42px] right-8 p-0">
          <Button variant="text" onClick={handleClose} className="p-0">
      ...
      >
        <DialogHeader className="items-start flex flex-wrap justify-between mb-6 p-0 pr-9 gap-3">
          <h3 className="text-white pt-2">Deposit via Mobile Money</h3>
          <span className="table-btn Active">Approved</span>
        </DialogHeader>
        <DialogBody divider className="border-none p-0">
          <h3 className="text-white text-[13px] font-medium leading-6">
            Abdul Qadeer Requested 100.00 USD
      ...
      <DepositHistoryModal item={item}  open={statusModal} handleOpen={handleClose}/>
    </>
  );
}
